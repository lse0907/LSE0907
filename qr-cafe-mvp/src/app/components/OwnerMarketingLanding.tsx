...
export default function OwnerMarketingLanding() {
  return (
    <main className="landing">
      ...
      <section className="videoPreview" aria-labelledby="video-preview-title">
        <div className="videoPoster">
          <Image src="/marketing/rion-order-cafe-qr-hero-v1.png" alt="향후 주문 흐름 소개 영상의 대표 이미지" fill sizes="(max-width: 760px) 100vw, 58vw" />
          <div className="videoShade" />
          <span className="playMark" aria-hidden="true">▶</span>
          <p>60 SEC · ORDER FLOW</p>
        </div>
        <div className="videoCopy">
          <p className="eyebrow">COMING VIDEO</p>
          <h2 id="video-preview-title">60초로 보는<br />매장 주문 흐름.</h2>
          <p>고객 주문 → 직원 접수 → 준비·전달. 실제 사용 화면을 짧게 연결한 영상이 이 자리에 들어갑니다.</p>
          <small>현재는 영상 위치와 구성만 보여주는 미리보기입니다.</small>
        </div>
      </section>
