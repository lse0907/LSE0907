...
function DoneStyles() {
  return <style jsx global>{`
    ...
    .customerNotificationCard { display:grid; grid-template-columns:36px 1fr auto; align-items:center; gap:10px; margin-top:14px; padding:12px; border:1px solid #cfe0ff; border-radius:14px; background:#f5f9ff; }
    .customerNotificationIcon { width:36px; height:36px; display:grid; place-items:center; border-radius:11px; background:#174a9c; color:#fff; font-size:13px; box-shadow:0 5px 12px rgba(23,74,156,.14); }
    .customerNotificationCopy h2 { margin:0; color:var(--rion-navy); font-size:14px; font-weight:800; letter-spacing:-.02em; }.customerNotificationCopy p { margin:3px 0 0; color:#526071; font-size:12px; line-height:1.35; }.customerNotificationConnected { display:inline-flex; align-items:center; margin-top:4px; color:#14734a; font-size:12px; font-weight:750; }.customerNotificationConnected::before { content:""; width:6px; height:6px; margin-right:5px; border-radius:50%; background:#22a06b; box-shadow:0 0 0 3px rgba(34,160,107,.12); }
    .customerNotificationButton,.customerNotificationTextButton { min-height:36px; padding:0 10px; border-radius:10px; font-size:12px; font-weight:750; cursor:pointer; white-space:nowrap; }.customerNotificationButton { border:0; background:var(--rion-navy); color:#fff; }.customerNotificationTextButton { border:1px solid #b7c8e8; background:#fff; color:#174a9c; }.customerNotificationButton:disabled,.customerNotificationTextButton:disabled { opacity:.55; cursor:not-allowed; }
    .customerNotificationHint { grid-column:2 / -1; margin:0; color:#174a9c; font-size:12px; font-weight:650; line-height:1.45; }
