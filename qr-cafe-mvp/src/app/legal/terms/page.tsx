...
export default async function TermsPage({ searchParams }: { searchParams: Promise<{ audience?: string }> }) {
  ...
  return (
    <LegalPolicyPage
      title={isOwner ? "사업자 회원 이용정책 안내" : "고객 이용정책 안내"}
