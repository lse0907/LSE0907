    ...
    <main className="wrap">
      ...
      <header className="topbar">
        <div>
          ...
          <p className="sub">
            고객 주문 화면에 보이는 정보와 매장 운영 설정을 관리합니다.
          </p>
        </div>
      ...
      {/* Main editor grid: keep sideStack and formStack as the only direct columns. */}
      <section className="grid">
        <div className="sideStack">
          <section className="card previewWrap">
            ...
            <div className="previewControls">
              <p className="sectionLead">
                대표 이미지와 로고를 등록하면 위 미리보기에 바로 반영됩니다.
              </p>

              <div className="uploadControlGrid">
                <div className="field">
                  <div className="label">
                    대표 이미지 업로드
                    <span
        ...
        {/* Basic information column: close this div before starting advancedGrid. */}
      ...
      {/* Advanced settings live outside the two-column grid to avoid nested section mismatches. */}
