...
export async function createCounterPosterCanvas({
  ...
  for (let i = 0; i < copies; i++) {
    ...
    if (template === "cafe_poster") {
      ...
      const photoLogoY = panelY + Math.round(36 * scale);
      ...
      ctx.font = `900 ${Math.round((isCompactCopy ? 23 : 27) * scale)}px ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, sans-serif`;
      ctx.fillText(ds.counter_title, textX, titleY + Math.round(40 * scale));
      ctx.fillStyle = "#374151";
      ctx.font = `800 ${Math.round((isCompactCopy ? 20 : 22) * scale)}px ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, sans-serif`;
      drawWrappedLines(ctx, lines, textX, titleY + Math.round(82 * scale), Math.round(31 * scale), descMaxLines);
      ...
      const qrY = topY + Math.round(posterH * (isCompactCopy ? 0.39 : 0.42));
      const brandY = topY + Math.round(isCompactCopy ? 86 * scale : 112 * scale);
      ...
      ctx.font = `850 ${Math.round((isCompactCopy ? 24 : 28) * scale)}px Georgia, Times New Roman, ui-serif, Noto Sans KR, serif`;
      ...
      ctx.font = `800 ${Math.round(22 * scale)}px ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, sans-serif`;
      drawWrappedLines(ctx, lines, centerX, qrY + qrSize + Math.round(62 * scale), Math.round(33 * scale), 2);
      ctx.textAlign = "start";
      ctx.fillStyle = accent;
      ...
      roundRect(ctx, cardX, cardY, cardW, cardH, Math.round(48 * scale), "rgba(255,255,255,0.80)", "#fed7aa");
      ctx.save();
      ...
      ctx.restore();
      ctx.textAlign = "center";
      roundRect(ctx, centerX - Math.round(90 * scale), cardY + Math.round(52 * scale), Math.round(180 * scale), Math.round(38 * scale), Math.round(999 * scale), "#ffedd5", "#fdba74");
      ctx.fillStyle = "#9a3412";
      ctx.font = `950 ${Math.round(15 * scale)}px ui-rounded, ui-sans-serif, system-ui, -apple-system, Segoe UI, Noto Sans KR, sans-serif`;
      ctx.fillText("QR ORDER", centerX, cardY + Math.round(78 * scale));
      const softLogoY = cardY + Math.round(126 * scale);
      const softLogoBottomY = ds.show_logo ? softLogoY + logoSize : cardY + Math.round(98 * scale);
      const softStoreY = ds.show_logo ? softLogoBottomY + Math.round(50 * scale) : cardY + Math.round(150 * scale);
      ...
      ctx.fillStyle = "#9a3412";
      ctx.font = `850 ${Math.round(28 * scale)}px ui-rounded, ui-sans-serif, system-ui, -apple-system, Segoe UI, Noto Sans KR, sans-serif`;
      ...
      const descBoxTop = qrY + qrSize + Math.round(64 * scale);
      const softDescY = descBoxTop + Math.round(38 * scale);
      ...
      roundRect(ctx, centerX - descBoxW / 2, descBoxTop, descBoxW, descBoxH, Math.round(24 * scale), "rgba(255,247,237,0.94)", "#fed7aa");
      ctx.fillStyle = "#57534e";
      ctx.font = `800 ${Math.round(24 * scale)}px ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, sans-serif`;
      drawWrappedLines(ctx, lines, centerX, softDescY, Math.round(34 * scale), descMaxLines);
      ...
      const simpleLogoY = cardY + Math.round(86 * scale);
      ...
      ctx.fillStyle = accent;
      ctx.font = `900 ${Math.round(30 * scale)}px ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, sans-serif`;
      ...
      ctx.font = `800 ${Math.round(24 * scale)}px ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, sans-serif`;
      ctx.textAlign = "center";
      drawWrappedLines(ctx, lines, centerX, Math.min(qrY + qrSize + Math.round(60 * scale), bottomLineY - Math.round(24 * scale)), Math.round(34 * scale), descMaxLines);
      ctx.textAlign = "start";
      ctx.fillStyle = accent;
