...
function AiBriefContent() {
  ...
  return <main className="aiBriefPage">
    ...
    {brief && meta ? <>
      ...
      {nextStep ? <section className="aiNext" aria-label="지금 확인할 내용"><span className="aiNextIcon"><AiIcon name="proposal" /></span><div><span className="aiSectionLabel">지금 확인할 내용</span><h2>{nextStep.title}</h2><p>{nextStep.body}</p></div><span className="aiNextLabel">{nextStep.label}</span></section> : null}
